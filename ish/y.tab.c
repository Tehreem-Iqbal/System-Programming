...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_BACKGROUND = 6,                 /* BACKGROUND  */
  YYSYMBOL_PIPE = 7,                       /* PIPE  */
  YYSYMBOL_PIPE_ERROR = 8,                 /* PIPE_ERROR  */
  YYSYMBOL_SEMICOLON = 9,                  /* SEMICOLON  */
  YYSYMBOL_REDIRECT_IN = 10,               /* REDIRECT_IN  */
  YYSYMBOL_REDIRECT_OUT = 11,              /* REDIRECT_OUT  */
  YYSYMBOL_REDIRECT_ERROR = 12,            /* REDIRECT_ERROR  */
  YYSYMBOL_APPEND = 13,                    /* APPEND  */
  YYSYMBOL_APPEND_ERROR = 14,              /* APPEND_ERROR  */
  YYSYMBOL_OPTION = 15,                    /* OPTION  */
  YYSYMBOL_STRING = 16,                    /* STRING  */
  YYSYMBOL_LOGICAL_AND = 17,               /* LOGICAL_AND  */
  YYSYMBOL_LOGICAL_OR = 18,                /* LOGICAL_OR  */
  YYSYMBOL_NEWLINE = 19,                   /* NEWLINE  */
  YYSYMBOL_YYACCEPT = 20,                  /* $accept  */
  YYSYMBOL_cmd_line = 21,                  /* cmd_line  */
  YYSYMBOL_separator = 22,                 /* separator  */
...
{
  "\"end of file\"", "error", "\"invalid token\"", "WORD", "COMMAND",
  "FILENAME", "BACKGROUND", "PIPE", "PIPE_ERROR", "SEMICOLON",
  "REDIRECT_IN", "REDIRECT_OUT", "REDIRECT_ERROR", "APPEND",
  "APPEND_ERROR", "OPTION", "STRING", "LOGICAL_AND", "LOGICAL_OR",
  "NEWLINE", "$accept", "cmd_line", "separator", "parameters", YY_NULLPTR
};
...
{
      14,   -15,   -15,    19,    -3,   -15,    -2,   -15,   -15,    -1,
       0,   -15,    -4,     1,    11,    12,    24,   -15,   -15,   -15,
     -15,   -15,   -15,   -15,   -15,    -3
};
...
{
       0,     7,    20,     0,     3,     1,     4,     9,    10,     5,
       0,    14,     0,     0,     0,     0,     0,    12,    13,    20,
      15,    16,    17,    18,    19,     2
};
...
{
      11,    20,    -8,   -11,    19,    25,    21,    12,    13,    14,
      15,    16,    17,    18,    -6,     1,    22,    23,     2,     5,
      -6,    -6,    -6,    -6,     0,     6,     7,     8,     9,    24
};

static const yytype_int8 yycheck[] =
{
       3,     5,     4,     4,     4,    19,     5,    10,    11,    12,
      13,    14,    15,    16,     0,     1,     5,     5,     4,     0,
       6,     7,     8,     9,    -1,     6,     7,     8,     9,     5
};
...
{
       0,     1,     4,    21,    23,     0,     6,     7,     8,     9,
      22,     3,    10,    11,    12,    13,    14,    15,    16,     4,
       5,     5,     5,     5,     5,    23
};
...
#line 44 "ish.y"
                                                        { printf("%s\n", (yyvsp[-1].string)); strcpy(commandsArray[commandCount++], (yyvsp[-1].string));  }
#line 1193 "y.tab.c"
    break;
...
#line 58 "ish.y"
                                    { printf("OPTION %s\n", (yyvsp[0].string)); strcpy(parametersArray[parameterCount][paramCount++], (yyvsp[0].string)); }
#line 1211 "y.tab.c"
    break;
