/*
Add a feature to display the file names after a alphabetic
sort. Read all the names in an array, then use qsort(3)
to sort the array and then display on screen
*/
